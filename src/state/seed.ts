...
export const SEED_CREW: CrewMember[] = [
  ...
  { id: 'daniel', image: '', name: 'Daniel', handle: '@dan',  dailyGoal: 150, level: 5, xp: 2410, streak: 31, today: 120, week: 540, total: 11180 },
  { id: 'sascha', image: '', name: 'Sascha', handle: '@sash', dailyGoal: 80,  level: 3, xp: 1420, streak: 9,  today: 60,  week: 280, total: 7550 },
];
